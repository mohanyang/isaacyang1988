...
public class RSAED {
	...
	public void performTest()
	{
        ...
        System.out.println("RSA Standard test");
        eng.init(true, pubParameters);
        try
        {
        	System.out.println("The input data is  " + new String(Hex.encode(data)));
        	data = eng.processBlock(data, 0, data.length);
            System.out.println("The output data is " + new String(Hex.encode(data)));
        }
        catch (Exception e)
        {
            System.out.println("RSA: failed - exception " + e.toString());
        }
        ...
        {
        	System.out.println("failed RAW edge Test");
        }
        ...
        {
        	System.out.println("failed RAW Test");
        }

        System.out.println("RSA 768-key test");
        ...
        if (!input.equals(new String(Hex.encode(data))))
        {
        	System.out.println("failed key generation (768) Test");
        }

        System.out.println("RSA 1024-key test");
        ...
        if (!input.equals(new String(Hex.encode(data))))
        {
        	System.out.println("failed key generation (1024) test");
        }
	}
	
    public static void main(String[] args) {
		// TODO Auto-generated method stub
    	new RSAED().performTest();
	}
}